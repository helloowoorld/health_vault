/*
  ...
  1. New Tables
    - `profiles` - User profiles with roles (patient, doctor, pharma)
    - `appointments` - Medical appointments between patients and doctors
    - `documents` - Medical documents with IPFS storage
    - `prescriptions` - Medical prescriptions with medications

  2. Security
    - Enable RLS on all tables
    - Add policies for authenticated users to access their own data
    - Add policies for doctors to access patient data
    - Add policies for pharmacies to access prescription data
*/
