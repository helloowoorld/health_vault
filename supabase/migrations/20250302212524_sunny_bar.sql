/*
  # Fix Database Connection Migration

  1. Functions
     - Creates test_connection function for connection testing
     - Creates create_tables_if_not_exist function to ensure tables exist
     - Creates exec_sql function for admin use
     - Creates create_profile_for_user function for user registration

  2. Tables
     - Creates profiles, appointments, documents, and prescriptions tables if they don't exist
     - Sets up proper constraints and defaults

  3. Security
     - Enables Row Level Security (RLS) on all tables
     - Creates policies for anonymous access for testing
